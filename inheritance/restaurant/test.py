from OOP.inheritance.restaurant.beverage.beverage import Beverage
from OOP.inheritance.restaurant.food.soup import Soup
from OOP.inheritance.restaurant.product import Product
