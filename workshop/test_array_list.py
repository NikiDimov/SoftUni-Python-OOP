...
from OOP.workshop.array_list import ArrayList
...
class TestArrayList(TestCase):
    ...
    def test_dictionize__when_even_values_count__expect_correct_result(self):
        self.al.append(1)
        self.al.append(2)
        self.al.append(3)
        self.al.append(4)
    ...
    def test_dictionize__when_odd_values_count__expect_correct_result(self):
        self.al.append(1)
        self.al.append(2)
        self.al.append(3)
        self.al.append(4)
    ...
    def test_move__when_moving_1_value__expect_to_move_1_value_from_the_start_to_the_end(self):
        self.al.append(1)
        self.al.append(2)
        self.al.append(3)
        self.al.append(4)
    ...
    def test_move__when_moving_3_values__expect_to_move_3_value_from_the_start_to_the_end(self):
        self.al.append(1)
        self.al.append(2)
        self.al.append(3)
        self.al.append(4)
    ...
    def test_overbound__expect_to_return_max_value(self):
        values = [x for x in range(15)]
        [self.al.append(x) for x in values]
    ...
    def test_sum__when_values__expect_to_return_correct_sum(self):
        self.al.append(1)
        self.al.append('2')
        self.al.append(3)
        expected = 5
    ...
    def test_sum__when_empty__expect_to_return_0(self):
